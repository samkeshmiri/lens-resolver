...
async function lazyInit() {
    ...
    await new Promise((resolve, reject)=>{
        this.files = new Map();
        (0, _pump.default)(getNodeStream(tarballResponse), // The "gz" in "tgz" stands for "gzip". The tarball needs to be decompressed
 ...
 */ function createTarballStream(canonicalBase, files) {
    ...
    extractStream.on('entry', (header, entryStream, next)=>{
        ...
        if (headerType === 'file') {
            ...
            return entryStream.pipe((0, _concatstream.default)((data)=>{
                try {
