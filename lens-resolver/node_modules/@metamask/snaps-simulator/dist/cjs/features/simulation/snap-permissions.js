...
_export(exports, {
    ExcludedSnapEndowments: function() {
        return ExcludedSnapEndowments;
    },
    unrestrictedMethods: function() {
        return unrestrictedMethods;
    },
...
var ExcludedSnapEndowments = Object.freeze([]);
var unrestrictedMethods = Object.freeze([
    "eth_blockNumber",
    "eth_call",
    "eth_chainId",
    "eth_coinbase",
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    ...
                    _iterator = Object.keys(_snapscontrollers.endowmentPermissionBuilders)[Symbol.iterator]();
                    _state.label = 2;
                case 2:
                ...
                case 8:
                    return [
                        2,
                        _to_consumable_array(new Set(_to_consumable_array(_snapsutils.DEFAULT_ENDOWMENTS).concat(_to_consumable_array(allEndowments))))
                    ];
            }
        });
    });
