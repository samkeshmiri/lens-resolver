...
import { Button, Modal, ModalContent, ModalHeader, ModalBody, ModalOverlay, ModalFooter, FormControl, FormLabel, Input, Switch, HStack, Textarea, Text, Divider, InputLeftAddon, InputRightAddon, InputGroup, Select, useColorMode } from "@chakra-ui/react";
import { fetchNpmMetadata, DEFAULT_NPM_REGISTRY } from "@metamask/snaps-controllers";
import { SnapIdPrefixes, getSnapPrefix, stripSnapPrefix } from "@metamask/snaps-utils";
import { useEffect, useState } from "react";
import { useDispatch, useSelector } from "../../hooks";
import { getOpen, getSesEnabled, getSnapId, getSnapVersion, getSrp, setOpen, setSnapId, setSnapVersion } from "./slice";
export var Configuration = function() {
    var dispatch = useDispatch();
    var snapUrl = useSelector(getSnapId);
    var snapVersion = useSelector(getSnapVersion);
    var srp = useSelector(getSrp);
    var sesEnabled = useSelector(getSesEnabled);
    var isOpen = useSelector(getOpen);
    var _useColorMode = useColorMode(), colorMode = _useColorMode.colorMode, toggleColorMode = _useColorMode.toggleColorMode;
    var _useState = _sliced_to_array(useState(stripSnapPrefix(snapUrl)), 2), snapIdInput = _useState[0], setSnapIdInput = _useState[1];
    var _useState1 = _sliced_to_array(useState(getSnapPrefix(snapUrl).slice(0, -1)), 2), snapIdPrefix = _useState1[0], setSnapIdPrefix = _useState1[1];
    var _useState2 = _sliced_to_array(useState([]), 2), npmVersions = _useState2[0], setNpmVersions = _useState2[1];
    var _useState3 = _sliced_to_array(useState(snapVersion), 2), selectedNpmVersion = _useState3[0], setSelectedNpmVersion = _useState3[1];
    var isNPM = snapIdPrefix === SnapIdPrefixes.npm.slice(0, -1);
    var handleClose = function() {
        dispatch(setSnapVersion(selectedNpmVersion));
        dispatch(setSnapId("".concat(snapIdPrefix, ":").concat(snapIdInput)));
                ...
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            return [
                                4,
                                fetchNpmMetadata(snapIdInput, new URL(DEFAULT_NPM_REGISTRY), fetch.bind(globalThis))
                            ];
                        case 1:
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ _jsxs(InputGroup, {
                                    children: [
                                        ...
                                        isNPM && npmVersions.length > 0 && /*#__PURE__*/ _jsx(InputRightAddon, {
                                            px: "0",
                                            bg: "chakra-body-bg",
                                            borderColor: "border.default",
