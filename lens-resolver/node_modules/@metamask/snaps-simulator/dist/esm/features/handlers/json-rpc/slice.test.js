...
import { jsonRpc as reducer, setJsonRpcRequest, setJsonRpcResponse, INITIAL_STATE, setJsonRpcRequestFromHistory, clearJsonRpcResponse } from "./slice";
describe("jsonRpc", function() {
    describe("setJsonRpcRequest", function() {
        it("sets the request", function() {
            var result = reducer(INITIAL_STATE, setJsonRpcRequest({
                origin: "foo"
            }));
    ...
    describe("setJsonRpcRequestFromHistory", function() {
        it("sets the request", function() {
            var result = reducer(INITIAL_STATE, setJsonRpcRequestFromHistory({
                origin: "foo"
            }));
            expect(result.request).toStrictEqual({
                origin: "foo"
    ...
    describe("setJsonRpcResponse", function() {
        it("sets the response", function() {
            var result = reducer(INITIAL_STATE, setJsonRpcResponse("foo"));
