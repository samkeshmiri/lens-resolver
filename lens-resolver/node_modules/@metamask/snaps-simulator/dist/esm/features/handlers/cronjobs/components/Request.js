...
export var Request = function() {
    var _errors_origin;
    var _useSelector = useSelector(getCronjobRequest), request = _useSelector.request, origin = _useSelector.origin;
    var _useForm = useForm({
        defaultValues: {
            origin: origin !== null && origin !== void 0 ? origin : "",
            request: request ? JSON.stringify(request, null, 2) : SAMPLE_JSON_RPC_REQUEST
        }
    }), handleSubmit = _useForm.handleSubmit, register = _useForm.register, control = _useForm.control, setValue = _useForm.setValue, errors = _useForm.formState.errors;
    ...
    var handlePrefill = function(data) {
        setValue("request", JSON.stringify(_object_spread({
            jsonrpc: "2.0",
            id: 1
        }, data), null, 2));
    };
