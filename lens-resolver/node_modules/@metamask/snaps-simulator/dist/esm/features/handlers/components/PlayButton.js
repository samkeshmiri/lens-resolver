...
export var PlayButton = function() {
    var handler = useHandler();
    var response = useSelector(function(state) {
        return state[handler].response;
    });
    var isError = response && hasProperty(response, "error");
    var isSuccess = response && !hasProperty(response, "error");
    var isLoading = useSelector(function(state) {
        return state[handler].pending;
    });
    var _useState = _sliced_to_array(useState(PlayButtonState.Ready), 2), state = _useState[0], setState = _useState[1];
    useEffect(function() {
        if (isLoading) {
    ...
    return /*#__PURE__*/ _jsxs(Button, {
        ...
        children: [
            state !== PlayButtonState.Loading && /*#__PURE__*/ _jsx(Icon, {
                icon: icons[state],
                width: "24px",
                "data-testid": "send-request-button-done"
            }),
            state === PlayButtonState.Loading && /*#__PURE__*/ _jsx(Box, {
                bg: "info.default",
                borderRadius: "50%",
                width: "24px",
