 ...
 */ export function validationSaga(param) {
    ...
    return _ts_generator(this, function(_state) {
        switch(_state.label){
            ...
            case 10:
                ...
                status = isValid1 ? ManifestStatus.Valid : ManifestStatus.Invalid;
                return [
                    4,
                    put(setResults(results))
                ];
            case 11:
                _state.sent();
                return [
        ...
        switch(_state.label){
            case 0:
                return [
                    4,
                    all([
                        takeLatest(validateManifest, validationSaga)
                    ])
                ];
            case 1:
                _state.sent();
