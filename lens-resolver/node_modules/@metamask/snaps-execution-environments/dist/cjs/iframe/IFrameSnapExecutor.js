...
Object.defineProperty(exports, "IFrameSnapExecutor", {
    enumerable: true,
    get: function() {
        return IFrameSnapExecutor;
    }
});
...
class IFrameSnapExecutor extends _BaseSnapExecutor.BaseSnapExecutor {
    /**
   ...
   * message streams.
   */ static initialize(stream = new _postmessagestream.WindowPostMessageStream({
        name: 'child',
        target: 'parent',
        ...
        (0, _pump.default)(stream, mux, stream, (error)=>{
            if (error) {
