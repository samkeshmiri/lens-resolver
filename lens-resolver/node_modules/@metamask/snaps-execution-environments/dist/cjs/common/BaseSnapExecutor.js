...
Object.defineProperty(exports, "BaseSnapExecutor", {
    enumerable: true,
    get: function() {
 ...
 */ const EXECUTION_ENVIRONMENT_METHODS = {
    ping: {
        struct: _validation.PingRequestArgumentsStruct,
        params: []
    },
    executeSnap: {
        struct: _validation.ExecuteSnapRequestArgumentsStruct,
        params: [
            'snapId',
            'sourceCode',
            'endowments'
    ...
    terminate: {
        struct: _validation.TerminateRequestArgumentsStruct,
        params: []
    },
    snapRpc: {
        struct: _validation.SnapRpcRequestArgumentsStruct,
        params: [
            'target',
            'handler',
            'origin',
...
class BaseSnapExecutor {
   ...
   */ async startSnap(snapId, sourceCode, _endowments1) {
        (0, _logging.log)(`Starting snap '${snapId}' in worker.`);
        if (this.snapPromiseErrorHandler) {
            (0, _globalEvents.removeEventListener)('unhandledrejection', this.snapPromiseErrorHandler);
        }
        if (this.snapErrorHandler) {
            (0, _globalEvents.removeEventListener)('error', this.snapErrorHandler);
        }
        ...
        const provider = new _providers.StreamProvider(this.rpcStream, {
        ...
        try {
            ...
            (0, _globalEvents.addEventListener)('unhandledRejection', this.snapPromiseErrorHandler);
            (0, _globalEvents.addEventListener)('error', this.snapErrorHandler);
   ...
   */ onTerminate() {
    ...
    registerSnapExports(snapId, snapModule) {
        ...
        data.exports = _snapsutils.SNAP_EXPORT_NAMES.reduce((acc, exportName)=>{
            ...
            if ((0, _validation.validateExport)(exportName, snapExport)) {
                return {
                    ...acc,
   ...
   */ createSnapGlobal(provider) {
        ...
        const request = async (args)=>{
            (0, _utils1.assertSnapOutboundRequest)(args);
   ...
   */ createEIP1193Provider(provider) {
        const originalRequest = provider.request.bind(provider);
        const request = async (args)=>{
            (0, _utils1.assertEthereumOutboundRequest)(args);
            const sanitizedArgs = (0, _utils.getSafeJson)(args);
            this.notify({
                method: 'OutboundRequest'
            });
   ...
   */ async executeInSnapContext(snapId, executor) {
    ...
    constructor(commandStream, rpcStream){
        ...
        this.methods = (0, _commands.getCommandMethodImplementations)(this.startSnap.bind(this), async (target, handlerName, args)=>{
            ...
            (0, _utils.assert)(handler !== undefined, `No ${handlerName} handler exported for snap "${target}`);
