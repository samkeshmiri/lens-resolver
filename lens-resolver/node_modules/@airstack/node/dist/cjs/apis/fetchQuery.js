...
function fetchQuery(query, variables) {
    return __awaiter(this, void 0, void 0, function () {
        var _variables, data, error, _a, response, _error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _variables = (0, stringifyObjectValues_1.stringifyObjectValues)(variables || {});
                    data = null;
                    error = null;
                    return [4 /*yield*/, (0, fetcher_1.fetchGql)(query, _variables)];
                case 1:
